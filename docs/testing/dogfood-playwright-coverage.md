...
| Terminal displays raw bracketed-paste control text                                 | The retired agent Logs parity path covered this; Talk-to-Lead terminal needs replacement coverage                                          | Pending                               |
