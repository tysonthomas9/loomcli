...
export interface components {
    schemas: {
        ...
        PatchIssueRequest: {
            ...
            /** @enum {string|null} */
            status?: "open" | "in_progress" | "blocked" | "deferred" | "review" | "closed" | null;
            ...
            defer_until?: string | null;
            /** @enum {string|null} */
            agent_state?: "idle" | "spawning" | "running" | "working" | "stuck" | "done" | "stopped" | "dead" | null;
        };
        CloseRequest: {
            reason?: string;
            session?: string;
        ...
        MutationPayload: {
            /** @enum {string} */
            type: "create" | "update" | "delete" | "comment" | "status" | "bonded" | "squashed" | "burned" | "refresh" | "terminal_session_change";
            issue_id: string;
            title?: string;
            assignee?: string;
            actor?: string;
        ...
        ObservabilityEvent: {
            /** @enum {string} */
            type: "task.claimed" | "task.started" | "task.completed" | "task.failed" | "agent.started" | "agent.restarted" | "agent.stopped" | "epic.assigned" | "epic.exhausted" | "pr.created" | "conflict.resolved" | "system.health_check" | "system.config_reloaded";
            /** Format: date-time */
            timestamp: string;
            agent?: string;
            role?: string;
