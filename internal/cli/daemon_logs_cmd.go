...
func loadDaemonLogsConfig(projectDir string) *DaemonConfig {
...
func listAgentLogs(projectDir string, config *DaemonConfig, state *DaemonState, stateErr error) {
...
func resolveAgentLogPath(projectDir string, config *DaemonConfig, role, worktree string) string {
