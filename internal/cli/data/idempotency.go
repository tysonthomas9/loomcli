...
// duplicates. acceptance_criteria left that list in PUPPET-522 and
// estimated_minutes in PUPPET-607 — fleet-db now persists both, so they
// correctly differentiate keys: two creates whose acceptance criteria or
// estimated minutes differ no longer persist identically and must not dedup
