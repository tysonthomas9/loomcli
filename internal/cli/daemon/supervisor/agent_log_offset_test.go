...
// account statement it always was.
//
// Exit 1, not 0: on this line the harness marker classifies a FAILED run.
// Reading it on a clean exit too is #454's classifyFromHarnessMarker (PUPPET-105),
// which is not below this commit in the loomcli chain; the union original of
// this test asserted that exit-0 case.
