...
func (d *Daemon) resolveRoleConfig(roleName string, agentIndex int) (config.RoleConfig, error) {
...
func mergeRoleConfig(base, overlay config.RoleConfig) config.RoleConfig {
