...
func scoreQueueCandidates(issues []backend.IssueData, constraints cli.RoleConstraints) ([]cli.TaskMatch, map[string]int) {
	var matched []cli.TaskMatch
...
func printQueueResults(matched []cli.TaskMatch, rejections map[string]int) {
