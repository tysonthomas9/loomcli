...
func createWorktrees(deps *cli.Deps, worktreesDir string) []string {
...
func createSingleWorktree(deps *cli.Deps, worktreesDir, name string) bool {
	if err := validateNewWorktreeName(name); err != nil {
