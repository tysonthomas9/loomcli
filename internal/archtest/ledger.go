...
var requiredMutationCommandIDs = []string{
	"agentprovisioning.begin",
	"agents.acquire-ownership",
	"agents.apply-lifecycle",
	"agents.archive-agent",
	"agents.bind-supervised-assignment-parent",
	"agents.create-agent",
	"agents.create-role",
	"agents.create-supervised-assignment",
	"agents.delete-role",
	"agents.ensure-managed-agent",
	"agents.ensure-managed-role",
	"agents.reconcile-desired-state",
	"agents.release-ownership",
	"agents.renew-ownership",
	"agents.repair-managed-role-prompt-file",
	"agents.retire-managed-supervised-assignment",
	"agents.retire-supervised-assignment",
	"agents.set-desired-state",
	"agents.set-desired-state-owned",
	"agents.update-agent",
	"agents.update-role",
	"agents.update-supervised-assignment-intent",
	"artifacts.declare",
	"artifacts.finalize",
	"artifacts.reference",
	"artifacts.upload",
	...
	"execution.record-outbox-delivery-result",
	...
	"interaction.claim-inbox",
	"interaction.complete-inbox",
	"interaction.deliver-assignment",
	"interaction.deliver-chat-message",
	"interaction.enqueue-inbox",
	"interaction.finish-session",
	"interaction.force-interrupt",
	...
	"interaction.update-terminal",
	"sourcecontrol.materialize-workspace",
	"workflowcatalog.activate-version",
	"workflowcatalog.approve-version",
	"workflowcatalog.author-managed-version",
	"workflowcatalog.author-version",
