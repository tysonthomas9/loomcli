...
describe("RejectCommentForm (IssueDetailPanel)", () => {
  ...
  describe("rendering", () => {
    ...
    it("renders label with question text", () => {
      ...
      expect(
        screen.getByText("Why are you rejecting this?"),
      ).toBeInTheDocument();
    });
  ...
  describe("submitting state", () => {
    it('shows "Submitting..." during submission', () => {
      ...
      expect(screen.getByTestId("reject-submit")).toHaveTextContent(
        "Submitting...",
      );
    });
  ...
  describe("error state", () => {
    it("displays error message when error prop is provided", () => {
      render(
        <RejectCommentForm {...defaultProps} error="Something went wrong" />,
      );

      expect(screen.getByTestId("reject-error")).toHaveTextContent(
