...
describe("EditableDescription", () => {
  ...
  describe("View Mode", () => {
    ...
    it("hides edit button when isEditable=false", () => {
      ...
      expect(
        screen.queryByTestId("description-edit-button"),
    ...
    it("shows placeholder when description is undefined", () => {
      ...
      expect(
        screen.getByText("No description. Click to add one."),
      ).toBeInTheDocument();
    });
    ...
    it("applies custom className", () => {
      render(
        <EditableDescription {...defaultProps} className="custom-class" />,
      );
      expect(screen.getByTestId("editable-description")).toHaveClass(
        "custom-class",
      );
    });
  });
  ...
  describe("Save Flow", () => {
    ...
    it("shows loading state during save", async () => {
      ...
      expect(screen.getByTestId("description-save")).toHaveTextContent(
        "Saving...",
      );
