/**
 * RejectCommentForm component.
 * Inline form for collecting feedback when rejecting an issue in the Review column.
 */
...
/**
 * RejectCommentForm provides a compact inline form for entering rejection feedback.
 * Features:
...
export function RejectCommentForm({
  ...
  // Stop click propagation to prevent card selection
  ...
  return (
    ...
    >
      <label className={styles.label} htmlFor={`reject-textarea-${issueId}`}>
        Why are you rejecting?
      </label>
      <textarea
        ref={textareaRef}
        id={`reject-textarea-${issueId}`}
