...
describe("EditableTitle", () => {
  ...
  describe("Edit Mode", () => {
    ...
    it("focuses input when entering edit mode", () => {
      ...
      expect(document.activeElement).toBe(
        screen.getByTestId("editable-title-input"),
      );
    });
  ...
  describe("Props sync", () => {
    it("syncs draft title when title prop changes", () => {
      ...
      fireEvent.click(screen.getByTestId("editable-title-display"));
      fireEvent.keyDown(screen.getByTestId("editable-title-input"), {
        key: "Escape",
      });
  ...
  describe("className prop", () => {
    it("applies custom className", () => {
      ...
      expect(screen.getByTestId("editable-title-display")).toHaveClass(
        "custom-class",
      );
    });
  });
