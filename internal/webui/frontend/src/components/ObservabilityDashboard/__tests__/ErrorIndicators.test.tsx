...
describe('ErrorIndicators', () => {
  describe('severity badges', () => {
    it('renders error rate badge with severity "ok" when rate <= 5', () => {
      const { container } = render(
        <ErrorIndicators errorRatePct={3.0} restartCount24h={1} restartsByAgent={{}} />
      );
    ...
    it('renders error rate badge with severity "warning" when rate > 5 and <= 15', () => {
      const { container } = render(
        <ErrorIndicators errorRatePct={12.0} restartCount24h={1} restartsByAgent={{}} />
      );
    ...
    it('renders error rate badge with severity "critical" when rate > 15', () => {
      const { container } = render(
        <ErrorIndicators errorRatePct={20.0} restartCount24h={1} restartsByAgent={{}} />
      );
    ...
    it('renders restart count badge with severity "warning" when count > 0', () => {
      render(
        <ErrorIndicators errorRatePct={1.0} restartCount24h={5} restartsByAgent={{}} />
      );
    ...
    it('renders restart count badge with severity "ok" when count is 0 but errorRate > 0', () => {
      render(
        <ErrorIndicators errorRatePct={2.0} restartCount24h={0} restartsByAgent={{}} />
      );
    ...
    it('uses singular "restart" when count is 1', () => {
      render(
        <ErrorIndicators errorRatePct={1.0} restartCount24h={1} restartsByAgent={{}} />
      );
    ...
    it('uses plural "restarts" when count is not 1', () => {
      render(
        <ErrorIndicators errorRatePct={1.0} restartCount24h={3} restartsByAgent={{}} />
      );
  ...
  describe('severity boundary values', () => {
    it('severity is "ok" at exactly 5%', () => {
      render(
        <ErrorIndicators errorRatePct={5.0} restartCount24h={1} restartsByAgent={{}} />
      );
    ...
    it('severity is "warning" at 5.1%', () => {
      render(
        <ErrorIndicators errorRatePct={5.1} restartCount24h={1} restartsByAgent={{}} />
      );
    ...
    it('severity is "warning" at exactly 15%', () => {
      render(
        <ErrorIndicators errorRatePct={15.0} restartCount24h={1} restartsByAgent={{}} />
      );
    ...
    it('severity is "critical" at 15.1%', () => {
      render(
        <ErrorIndicators errorRatePct={15.1} restartCount24h={1} restartsByAgent={{}} />
      );
  ...
  describe('agent restart list', () => {
    it('renders agents sorted by restart count descending', () => {
      ...
      const { container } = render(
        <ErrorIndicators errorRatePct={10} restartCount24h={9} restartsByAgent={restartsByAgent} />
      );
    ...
    it('filters out agents with 0 restarts', () => {
      ...
      const { container } = render(
        <ErrorIndicators errorRatePct={5} restartCount24h={4} restartsByAgent={restartsByAgent} />
      );
    ...
    it('does not render agent list when restartsByAgent is empty', () => {
      const { container } = render(
        <ErrorIndicators errorRatePct={5} restartCount24h={1} restartsByAgent={{}} />
      );
  ...
  describe('empty state', () => {
    it('shows empty state when no errors and no restarts', () => {
      render(
        <ErrorIndicators errorRatePct={0} restartCount24h={0} restartsByAgent={{}} />
      );
    ...
    it('does not show empty state when only restartCount > 0', () => {
      render(
        <ErrorIndicators errorRatePct={0} restartCount24h={2} restartsByAgent={{}} />
      );
