...
describe("ViewSwitcher", () => {
  describe("rendering", () => {
    it("renders all six view tabs", () => {
      ...
      expect(screen.getByTestId("view-tab-workflows")).toBeInTheDocument();
    });
  ...
  describe("interactions", () => {
    ...
    it("disables all tabs when disabled prop is true", () => {
      ...
      expect(screen.getByTestId("view-tab-workflows")).toBeDisabled();
    });
  });
  ...
  describe("keyboard navigation", () => {
    ...
    it("wraps around at the end", () => {
      const onChange = vi.fn();
      render(<ViewSwitcher activeView="workflows" onChange={onChange} />);
  ...
  describe("CSS classes - header redesign", () => {
    it("all tab buttons use tab CSS class", () => {
      const { container } = render(
        <ViewSwitcher activeView="kanban" onChange={() => {}} />,
      );
  ...
  describe("orientation", () => {
    ...
    it("sets aria-orientation to vertical when orientation is vertical", () => {
      ...
      expect(screen.getByTestId("view-switcher")).toHaveAttribute(
        "aria-orientation",
        "vertical",
      );
    });
