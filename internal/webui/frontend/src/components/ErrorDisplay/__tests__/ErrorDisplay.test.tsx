...
describe("ErrorDisplay", () => {
  ...
  describe("custom content", () => {
    it("renders custom title", () => {
      ...
      expect(
        screen.getByRole("heading", { name: "Custom Error Title" }),
      ).toBeInTheDocument();
    });
    ...
    it("custom title overrides variant default", () => {
      ...
      expect(
        screen.getByRole("heading", { name: "Override Title" }),
      ).toBeInTheDocument();
    ...
    it("custom description overrides variant default", () => {
      render(
        <ErrorDisplay variant="fetch-error" description="Override desc" />,
      );
  ...
  describe("edge cases", () => {
    ...
    it("renders with all optional props", () => {
      ...
      expect(
        screen.getByRole("heading", { name: "All props title" }),
      ).toBeInTheDocument();
