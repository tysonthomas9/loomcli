...
describe("BulkActionToolbar", () => {
  ...
  describe("rendering", () => {
    ...
    it("applies custom className", () => {
      ...
      expect(screen.getByTestId("bulk-action-toolbar")).toHaveClass(
        "custom-class",
      );
    });
  ...
  describe("deselect all", () => {
    ...
    it("deselect button has correct text", () => {
      render(<BulkActionToolbar {...defaultProps} />);
      expect(screen.getByTestId("bulk-action-clear")).toHaveTextContent(
        "Deselect all",
      );
    });
  ...
  describe("actions", () => {
    ...
    it("shows loading state", () => {
      ...
      render(<BulkActionToolbar {...defaultProps} actions={actions} />);
      expect(screen.getByTestId("bulk-action-close")).toHaveTextContent(
        "Loading...",
      );
    });
