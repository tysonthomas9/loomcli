...
describe("IssueRow", () => {
  describe("rendering", () => {
    ...
    it("renders cell content correctly for each column type", () => {
      ...
      // Check title cell
      expect(
        container.querySelector('[data-column="title"]'),
  ...
  describe("cell content", () => {
    describe("priority badge", () => {
      it.each([0, 1, 2, 3, 4] as const)(
        ...
        (priority) => {
          ...
          const priorityCell = container.querySelector(
    ...
    describe("status badge", () => {
      const statusTests: {
        ...
        {
          status: "blocked",
          expectedClass: "status-blocked",
          expectedText: "Blocked",
        },
        {
          status: "closed",
          expectedClass: "status-closed",
          expectedText: "Closed",
        },
        {
          status: "deferred",
          expectedClass: "status-deferred",
          expectedText: "Deferred",
        },
      ];
    ...
    describe("missing fields", () => {
      ...
      it('missing assignee shows "-" placeholder', () => {
        ...
        const assigneeCell = container.querySelector(
  ...
  describe("checkbox functionality", () => {
    it("does not render checkbox when showCheckbox is false", () => {
      ...
      expect(
        container.querySelector(".issue-table__checkbox"),
    ...
    it("checkbox click does not trigger row onClick", () => {
      ...
      const checkboxCell = container.querySelector(
