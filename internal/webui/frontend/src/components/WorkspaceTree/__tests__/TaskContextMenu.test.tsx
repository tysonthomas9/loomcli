...
/**
 * Unit tests for TaskContextMenu component.
...
describe("TaskContextMenu", () => {
  ...
  describe("click interactions", () => {
    it("fires onRename and onClose when Rename is clicked", () => {
      ...
      fireEvent.click(screen.getByTestId("task-context-menu-rename"));
    ...
    it("fires onRename and onClose when Enter key is pressed on Rename", () => {
      ...
      const button = screen.getByTestId("task-context-menu-rename");
    ...
    it("fires onMarkDone and onClose when Mark as Done is clicked", () => {
      ...
      fireEvent.click(screen.getByTestId("task-context-menu-done"));
    ...
    it("fires onMarkDone and onClose when Enter key is pressed on Mark as Done", () => {
      ...
      const button = screen.getByTestId("task-context-menu-done");
      fireEvent.keyDown(button, { key: "Enter" });
    ...
    it("fires onArchive and onClose when Archive is clicked", () => {
      ...
      fireEvent.click(screen.getByTestId("task-context-menu-archive"));
    ...
    it("fires onArchive and onClose when Enter key is pressed on Archive", () => {
      ...
      const button = screen.getByTestId("task-context-menu-archive");
      fireEvent.keyDown(button, { key: "Enter" });
    ...
    it("applies dangerItem styling to Archive button", () => {
      ...
      const archiveButton = screen.getByTestId("task-context-menu-archive");
