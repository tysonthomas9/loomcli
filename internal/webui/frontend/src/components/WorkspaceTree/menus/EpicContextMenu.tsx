/**
 * EpicContextMenu — context menu for epic rows.
...
export function EpicContextMenu({
  ...
  onArchive,
  onClose,
}: EpicContextMenuProps): JSX.Element | null {
  ...
  return (
    ...
    >
      <button
        ...
        role="menuitem"
        data-testid="epic-context-menu-rename"
      >
        <svg
          width="14"
          height="14"
      ...
      <button
        ...
        role="menuitem"
        data-testid="epic-context-menu-done"
      >
        <svg
          width="14"
          height="14"
      ...
      <button
        ...
        role="menuitem"
        data-testid="epic-context-menu-archive"
      >
        <svg
          width="14"
          height="14"
