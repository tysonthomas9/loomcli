...
export const ALLOWLIST = new Map([
  ...
  ["src/components/TerminalView/TerminalView.tsx", 885],
  ["src/components/TerminalView/TerminalTabBar.tsx", 547],
  ["src/components/TerminalView/TerminalInstance.tsx", 699],
