...
export const ALLOWLIST = new Map([
  ["src/components/IssueDetailPanel/IssueDetailPanel.tsx", 1459],
  ["src/App.tsx", 1013],
  ...
  ["src/components/TerminalView/TerminalView.tsx", 550],
  ["src/components/TerminalView/TerminalInstance.tsx", 518],
]);
