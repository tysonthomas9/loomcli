...
func TestSessionRouteMigration_OldFlatRoutesReturn404(t *testing.T) {
	...
	setupRoutes(mux, nil, multiPool, nil, nil, nil, nil, nil, nil, "", false, nil, nil, nil, false, false, "", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, sessStore, wsExistsFn, "", nil, "", nil)
