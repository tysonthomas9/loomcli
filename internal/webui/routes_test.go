...
func TestSetupRoutes_FlatTerminalWSEndpointReturns404(t *testing.T) {
	...
	setupRoutes(mux, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, "", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil, "")
...
func TestSetupRoutes_FlatTerminalRoutesReturn404(t *testing.T) {
	...
	mux := http.NewServeMux()
	setupRoutes(mux, nil, nil, nil, nil, termMgr, nil, nil, nil, nil, nil, nil, false, "", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil, "")
...
func TestSetupRoutes_FleetEndpointsNotRegisteredWhenDisabled(t *testing.T) {
	mux := http.NewServeMux()
	setupRoutes(mux, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, "", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil, "") // fleetEnabled=false
...
func TestSetupRoutes_FlatFleetRoutesReturn404(t *testing.T) {
	mux := http.NewServeMux()
	setupRoutes(mux, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, "", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil, "") // fleetEnabled=true
...
func TestSetupRoutes_SSEEndpointRegisteredOnWorkspaceScope(t *testing.T) {
	...
	setupRoutes(mux, nil, multiPool, hub, nil, nil, nil, nil, nil, nil, nil, nil, false, "", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, wsExistsFn, nil, "", nil, nil, "")
...
func TestSetupRoutes_WorkspaceBackendPatchEndpoint(t *testing.T) {
	...
	setupRoutes(mux, nil, multiPool, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, "", "", nil, nil, nil, nil, workspaceConfigFn, nil, nil, nil, nil, nil, nil, nil, wsExistsFn, nil, "", nil, nil, "")
...
func TestSetupRoutes_FlatTerminalTokenReturns404(t *testing.T) {
	...
	mux := http.NewServeMux()
	setupRoutes(mux, nil, nil, nil, nil, termMgr, termAuth, nil, nil, nil, nil, nil, false, "", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil, "")
...
func TestSetupRoutes_IssueEndpoints_MethodRestrictions(t *testing.T) {
	...
	mux := http.NewServeMux()
	setupRoutes(mux, pool, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, "", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil, "")
...
func TestSetupRoutes_DevMode_FrontendHandler(t *testing.T) {
	...
	setupRoutes(mux, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, true, "/nonexistent/dev/dir", "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil, "")
...
func TestSetupRoutes_LoomProxy_RegisteredWhenURLSet(t *testing.T) {
	...
	mux := http.NewServeMux()
	setupRoutes(mux, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, "", "http://localhost:9999", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil, "")
...
func TestSetupRoutes_LoomProxy_NotRegisteredWhenURLInvalid(t *testing.T) {
	...
	setupRoutes(mux, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, "", "http://external-host.example.com:9999", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil, "")
...
func TestLegacyFlatAgentRoutesRemoved(t *testing.T) {
	...
	setupRoutes(mux, nil, multiPool, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, "", "", gitOps, fileOps, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, wsExistsFn, nil, "", nil, nil, "")
