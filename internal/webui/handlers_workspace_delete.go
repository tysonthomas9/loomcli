...
// The deleteFn is expected to be wrapped by wrapWorkspaceDeleteFn, which
// handles post-deletion cleanup (pool, subscriber, and fleet deregistration)
// transparently. Returns refreshed workspace data via workspaceConfigFn.
