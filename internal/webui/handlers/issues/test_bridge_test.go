...
// ---------------------------------------------------------------------------
// Test-local SessionService for this package's handler tests.
// ---------------------------------------------------------------------------
...
func (s *testSessionServiceImpl) GetSessionTranscriptByID(_ context.Context, _, sessionID string) ([]transcript.Event, error) {
	return s.GetSessionTranscript(context.Background(), "", "", sessionID)
}
...
func (s *stubSessionService) GetSessionTranscriptByID(_ context.Context, _, _ string) ([]transcript.Event, error) {
	return nil, nil
}
