...
func TestHandleListSessionsByIssue_NilStore(t *testing.T) {
	handler := handleListSessionsByIssue(NewTerminalService(nil, nil, nil, nil, nil, nil, nil, nil))
...
func TestHandleListSessionsByIssue_EmptyStore(t *testing.T) {
	...
	handler := handleListSessionsByIssue(NewTerminalService(nil, nil, nil, store, nil, nil, nil, nil))
...
func TestHandleCloseAllSessions_NilManager(t *testing.T) {
	handler := handleCloseAllSessions(NewTerminalService(nil, nil, nil, nil, nil, nil, nil, nil))
...
func TestHandleCloseAllSessions_DeletesTabMetadata(t *testing.T) {
	...
	handler := handleCloseAllSessions(NewTerminalService(mgr, nil, nil, store, hub, nil, nil, nil))
