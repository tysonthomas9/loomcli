...
func (m *workspaceRoutesMockWorkspaceService) GetActiveWorkspace(_ context.Context) (*operationalview.Workspace, error) {
	return &operationalview.Workspace{}, nil
}
func (m *workspaceRoutesMockWorkspaceService) GetWorkspace(_ context.Context, _ string) (*operationalview.Workspace, error) {
	return nil, apperrors.ErrNotFound("not found")
}
func (m *workspaceRoutesMockWorkspaceService) CreateWorkspace(_ context.Context, _ workspacecoord.WorkspaceCreateRequest) (*operationalview.Workspace, []string, error) {
	return nil, nil, apperrors.ErrUnavailable("not available")
}
func (m *workspaceRoutesMockWorkspaceService) AddWorkspaceRepos(_ context.Context, _ workspacecoord.WorkspaceAddReposRequest) (*operationalview.Workspace, error) {
...
func (m *workspaceRoutesMockWorkspaceService) DeleteWorkspace(_ context.Context, _ string) (*operationalview.Workspace, error) {
	return nil, apperrors.ErrUnavailable("not available")
}
...
func (m *workspaceRoutesMockWorkspaceService) PatchWorkspaceBackend(_ context.Context, _ string, _ string) (*operationalview.Workspace, error) {
	return nil, apperrors.ErrUnavailable("not available")
}
