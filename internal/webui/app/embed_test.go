...
func discoverAssetFilenames() (cssFile, jsFile string) {
	distFS, err := fs.Sub(webui.FrontendFS, "frontend/dist/assets")
	if err != nil {
		return "", ""
	}
...
func TestShouldCache(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := webui.ShouldCache(tt.urlPath)
			if result != tt.expected {
				t.Errorf("webui.ShouldCache(%q) = %v, want %v", tt.urlPath, result, tt.expected)
			}
		})
	}
}
...
func TestSetCacheHeaders(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			webui.SetCacheHeaders(w, tt.cache)
...
func TestHandleHealth(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			healthhandlers.HandleHealth(nil)(w, req)
...
func TestDevFrontendHandler_ServesFilesFromDisk(t *testing.T) {
	...
	handler := webui.DevFrontendHandler(dir)
...
func TestDevFrontendHandler_DefaultDir(t *testing.T) {
	handler := webui.DevFrontendHandler("")
...
func TestSetupRoutes_DevMode(t *testing.T) {
	...
	app := &Server{config: webui.ServerConfig{DevMode: true, DevFrontendDir: dir}}
	setupTestRoutes(t, app)
