...
const (
	...
	// validateConnection re-validates it with a Ping. Connections used more
	// recently than this are assumed healthy, avoiding a redundant RPC
	// round-trip on the PutAfterError path.
