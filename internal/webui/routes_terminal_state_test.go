...
func TestTerminalStateRouteMigration_OldFlatRoutesReturn404(t *testing.T) {
	...
	setupRoutes(mux, nil, multiPool, nil, nil, termMgr, nil, nil, nil, "", false, nil, nil, nil, false, false, "", "", nil, nil, tms, nil, nil, nil, nil, nil, nil, nil, nil, nil, wsExistsFn, "", nil, "", nil)
...
func TestTerminalStateRouteMigration_StateEndpointsReturnJSON(t *testing.T) {
	...
	setupRoutes(mux, nil, multiPool, nil, nil, nil, nil, nil, nil, "", false, nil, nil, nil, false, false, "", "", nil, nil, tms, nil, nil, nil, nil, nil, nil, nil, nil, nil, wsExistsFn, "", nil, "", nil)
