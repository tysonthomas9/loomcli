...
func TestSetupRoutes(t *testing.T) {
	...
	setupRoutes(mux, nil, nil, nil, nil, "", nil, nil, nil, "", false, nil) // nil pool, hub, getMutationsSince, termManager for basic routing tests
...
func TestHealthEndpointJSON(t *testing.T) {
	mux := http.NewServeMux()
	setupRoutes(mux, nil, nil, nil, nil, "", nil, nil, nil, "", false, nil) // nil pool, hub, getMutationsSince, termManager for basic health tests
