...
const (
	...
	ActionGitHubPullRequestRead = domain.ActionGitHubPullRequestRead
	...
	ActionGitHubReviewPost = domain.ActionGitHubReviewPost
	...
	ActionGitHubMerge = domain.ActionGitHubMerge
	// ActionGitHubPullsList lists pull requests (merge-conflict agent,
	// read-only).
	ActionGitHubPullsList = domain.ActionGitHubPullsList
	// ActionGitHubCompareRead compares two refs (read-only).
	ActionGitHubCompareRead = domain.ActionGitHubCompareRead
	// ActionGitHubIssueCommentPost posts an issue/PR comment.
	ActionGitHubIssueCommentPost = domain.ActionGitHubIssueCommentPost
)

// GitHubActions returns the actions the GitHub provider implements (a copy).
func GitHubActions() []string {
	return domain.ActionsForSource(domain.ConnectorSourceGitHub)
}
