...
// bump this constant.
const expectedClientCallSites = 239
...
var clientRoutes = []clientRoute{
	...
	// work_item_move.go — backend-atomic source retirement + target creation.
	{"POST", "/api/v1/{}/issues/{}/move"},
	...
	// narrow session-owned transport; those five call sites are counted by the
	...
	{"POST", "/api/v1/{}/artifacts/{}/commands/fail"},
	...
	{"POST", "/api/v1/{}/drivers/{}/versions/{}/availability"},
