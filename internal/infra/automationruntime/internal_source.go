...
type InternalSource struct {
	...
	// automation.DefaultInternalEventHopDepthCap apply.
	HopDepthCap int
...
func marshalInternalEnvelope(origin automation.EventOrigin, hopDepth int, ev InternalEvent) (json.RawMessage, error) {
...
func (s *InternalSource) dispatchAwaits(ctx context.Context, ws, eventID, eventType string, origin automation.EventOrigin, ev InternalEvent) {
...
func (s *InternalSource) guardProvenance(ctx context.Context, ws, eventID, eventType, routeKey string, ev InternalEvent) (automation.EventOrigin, int, *InternalEmitResult, error) {
	origin := ev.Origin
	if origin == "" {
...
func (s *InternalSource) effectiveHopDepthCap() int {
	...
	return automation.DefaultInternalEventHopDepthCap
}
