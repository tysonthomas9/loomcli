...
func (s *CronScheduler) sweepBinding(ctx context.Context, ws string, binding *automation.Binding, now time.Time) (bool, error) {
...
func (s *CronScheduler) dispatchTick(ctx context.Context, ws string, binding *automation.Binding, fire time.Time) error {
