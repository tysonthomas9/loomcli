...
// Adapter projects the local stack-lineage representation onto Source
// Control's owner-scoped persistence ports. Keeping the projection beside the
// concrete local store avoids a second infrastructure package whose only job
// was forwarding to this package.
