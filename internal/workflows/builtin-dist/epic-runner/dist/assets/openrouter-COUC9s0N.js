...
//#region ../../../../../../../Users/tyson/codebase/code-agents/dynamic-workflows/flue/node_modules/.pnpm/@earendil-works+pi-ai@0.79.0_@modelcontextprotocol+sdk@1.29.0_@cfworker+json-schema@4.1.1_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/providers/images/openrouter.js
var generateImagesOpenRouter = async (model, context, options) => {
	const output = {
		api: model.api,
	...
	try {
		...
		const { data: response, response: rawResponse } = await client.chat.completions.create(params, requestOptions).withResponse();
		...
		if (imageResponse.usage) output.usage = parseUsage(imageResponse.usage, model);
		const choice = imageResponse.choices[0];
		if (choice) {
			const content = choice.message.content;
			if (typeof content === "string" && content.length > 0) output.output.push({
				type: "text",
				text: content
			});
...
//# sourceMappingURL=openrouter-COUC9s0N.js.map