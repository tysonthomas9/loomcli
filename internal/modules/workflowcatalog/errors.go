...
var (
	...
	ErrVersionNotAvailable   = errors.New("workflow catalog: version bundle is not available")
	...
	ErrAvailabilityConflict  = errors.New("workflow catalog: availability intent conflicts with durable state")
