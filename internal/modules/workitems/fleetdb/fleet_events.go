...
func (b *Adapter) getMutationsAfter(ctx context.Context, op, cursor string, timeoutMs int64) ([]workitems.Mutation, error) {
	params := url.Values{}
...
func (b *Adapter) GetMutationsAfter(ctx context.Context, cursor string) ([]workitems.Mutation, error) {
...
func (b *Adapter) WaitForMutationsAfter(ctx context.Context, cursor string, timeoutMs int64) ([]workitems.Mutation, error) {
