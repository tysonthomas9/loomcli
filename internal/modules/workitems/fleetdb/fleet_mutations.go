...
func (b *Adapter) postDependency(ctx context.Context, command workitems.AddDependencyCommand) error {
...
func (b *Adapter) addLabel(ctx context.Context, id string, label string) error {
	req := struct {
...
func (b *Adapter) removeLabel(ctx context.Context, id string, label string) error {
