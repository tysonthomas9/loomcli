...
func (b *Adapter) ClaimAsActor(ctx context.Context, id string, lockTTL time.Duration, actor string) error {
	if id == "" {
...
func (b *Adapter) RenewClaimAsActor(ctx context.Context, id string, lockTTL time.Duration, actor string) error {
	if id == "" {
...
func (b *Adapter) ReleaseIssueLock(ctx context.Context, id, actor string) error {
	return b.releaseIssueLock(ctx, "ReleaseIssueLock", id, actor, true)
}

func (b *Adapter) releaseIssueLock(ctx context.Context, op, id, actor string, useConfiguredActor bool) error {
	if id == "" {
...
func (b *Adapter) ReleaseIssueAsActor(ctx context.Context, id string, actor string) error {
