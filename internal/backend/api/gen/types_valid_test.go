...
func TestGeneratedEnumValidMethods(t *testing.T) {
	tests := []struct {
		...
		{"ListDeliveryGroupsParamsState", ListDeliveryGroupsParamsStateActive, ListDeliveryGroupsParamsState("invalid")},
		{"DeliveryGroupViewState", DeliveryGroupViewStateActive, DeliveryGroupViewState("invalid")},
