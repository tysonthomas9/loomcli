...
func recoveryTestDocument() map[string]any {
	return map[string]any{"manifest": recoveryManifest, "workspace": "WS", "through": "c2.MTAtMA", "issues": []any{}, "total": 0, "ready": []any{}, "blocked": []any{}, "deferred": []any{}, "dependencies": []any{}, "comments": []any{}, "history": nil}
}
