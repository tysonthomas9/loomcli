...
func TestEmitSeparatesVerifiedSourceFromEventContent(t *testing.T) {
	...
	if gotCommand.WorkspaceKey != "WS" || gotCommand.SourceKind != automation.SourceKindInternal || gotCommand.SourceEventID != "journal-1" || gotCommand.EventType != "issue.create" || gotCommand.ActorRef != "" {
...
func TestNewRequiresDependencies(t *testing.T) {
	...
	admission := admissionFunc(func(context.Context, automation.EventAuthority, automation.AdmitEventCommand) (*automation.AdmissionResult, error) {
		return nil, nil
	})
