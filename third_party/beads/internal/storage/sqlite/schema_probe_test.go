...
func TestProbeSchema_MissingColumn(t *testing.T) {
	...
	_, err = db.Exec(`
		...
		CREATE TABLE comments (id INTEGER PRIMARY KEY AUTOINCREMENT, issue_id TEXT NOT NULL, author TEXT NOT NULL, text TEXT NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, parent_id INTEGER, edited_at DATETIME, deleted_at DATETIME);
		CREATE TABLE comment_reactions (id INTEGER PRIMARY KEY AUTOINCREMENT, comment_id INTEGER NOT NULL, author TEXT NOT NULL, emoji TEXT NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(comment_id, author, emoji));
		CREATE TABLE comment_edits (id INTEGER PRIMARY KEY AUTOINCREMENT, comment_id INTEGER NOT NULL, old_text TEXT NOT NULL, new_text TEXT NOT NULL, edited_by TEXT NOT NULL, edited_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP);
