...
local-mode-team-verify:
	@test/local-mode/verify-team-template.sh "$(TEAM)"
...
help:
	...
	@echo "  make local-mode-team-verify TEAM=all - Verify Team Templates against a running local-mode stack"
