...
func CanonicalCatalog() []CaseDefinition {
	return []CaseDefinition{
		...
		app(85, "Trees left by losing CAS attempts are retained through a grace period and eventually collectible.", "fleet", "retention", fleet()),
		app(86, "Current pointers, retained history, active materialization leases, in-progress publication, rollback windows, and holds are GC roots.", "fleet", "retention-roots", fleet()),
		app(87, "Collection is generation/fence protected against concurrent publication.", "fleet", "retention-concurrency", fleet()),
