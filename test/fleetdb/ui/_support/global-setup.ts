...
export default async function globalSetup(): Promise<void> {
  ...
  // Escape hatch: FLEETDB_SKIP_PREFLIGHT=1 skips the preflight's environment
  ...
  if (process.env.FLEETDB_SKIP_PREFLIGHT === "1") {
    ...
    console.log("[global-setup] FLEETDB_SKIP_PREFLIGHT=1 — preflight bypassed");
    return;
  }
  // eslint-disable-next-line no-console
  console.log("[global-setup] running fleetdb-regression preflight...");
