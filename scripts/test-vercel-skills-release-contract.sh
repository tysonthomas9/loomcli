...
require_fixed "$workflow" 'E2E_COVERAGE_OUTPUT: ${{ github.workspace }}/e2e-coverage-${{ matrix.backend }}-${{ matrix.storage }}.yaml'
require_fixed "$workflow" 'e2e-coverage-${{ matrix.backend }}-${{ matrix.storage }}.yaml'
