...
require_fixed "$workflow" 'name: Generated workspace-file contract pair'
require_fixed "$workflow" 'go run ./cmd/gen-workspace-file-contract -check'
require_fixed "$workflow" '-loom-out ../loomcli/internal/domain/workspace_file_contract_gen.go'
require_fixed "$workflow" 'needs: [resolve, generated-contract]'
...
require_fixed "$workflow" '--platform linux/amd64'
require_fixed "$workflow" 'postgres:16-alpine@sha256:075f7ba66bc9b3ce7d6b8b635208ff61cd7cf1a67d71ec530eec5d7ae0cbe571'
